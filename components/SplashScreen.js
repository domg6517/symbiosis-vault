...
const PrismaticCanvas = ({ width = 390, height = 844 }) => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      atmo.addColorStop(0, "rgba(20,45,50,0.35)");
      atmo.addColorStop(0.6, "rgba(10,25,30,0.15)");
      ...
      ctx.rotate(angle);
      const beams = [
        { o: -0.04, c1: "rgba(255,255,255,0.35)", c2: "rgba(255,240,220,0.12)", w: 50 },
        { o: -0.07, c1: "rgba(255,245,230,0.22)", c2: "rgba(255,220,180,0.08)", w: 80 },
        { o: -0.01, c1: "rgba(255,160,80,0.45)", c2: "rgba(255,100,40,0.12)", w: 70 },
        { o: 0.02, c1: "rgba(255,80,40,0.40)", c2: "rgba(200,30,10,0.08)", w: 65 },
        { o: 0.05, c1: "rgba(200,40,20,0.30)", c2: "rgba(140,20,10,0.06)", w: 55 },
        { o: 0.08, c1: "rgba(160,30,20,0.18)", c2: "rgba(100,15,5,0.04)", w: 45 },
        { o: -0.10, c1: "rgba(255,200,160,0.12)", c2: "rgba(255,160,120,0.04)", w: 140 },
        { o: 0.14, c1: "rgba(60,220,200,0.16)", c2: "rgba(40,160,150,0.04)", w: 70 },
        { o: 0.18, c1: "rgba(40,180,220,0.12)", c2: "rgba(20,120,160,0.03)", w: 60 },
        { o: 0.11, c1: "rgba(80,200,120,0.08)", c2: "rgba(40,150,80,0.02)", w: 50 },
      ];
      const bL = H * 1.8;
      beams.forEach(b => {
        ctx.save();
      ...
      hs.addColorStop(0, "rgba(255,230,190,0.35)");
      hs.addColorStop(0.15, "rgba(255,180,120,0.18)");
      hs.addColorStop(0.4, "rgba(255,100,60,0.06)");
      hs.addColorStop(1, "transparent");
      ctx.fillStyle = hs;
      ctx.fillRect(0, 0, W, H);
      const mg = ctx.createRadialGradient(W*0.25, H*0.55, 0, W*0.25, H*0.55, 200);
      mg.addColorStop(0, "rgba(255,140,80,0.08)");
      mg.addColorStop(0.5, "rgba(255,80,40,0.03)");
      ...
      fr.addColorStop(0, "rgba(0,255,200,0.06)");
      fr.addColorStop(0.3, "rgba(0,200,255,0.03)");
